...
<html>
<head>
<title>i-Fit - <s:property value="context.ViewProductProjectorOB.productsDBBean.productname" /> on rent.</title>
					...
					<div class="single_left">
						...
						<div class="desc1 span_3_of_2">
							...
							<div class="det_nav">
								...
								<ul>
									<s:iterator
										...
										<li>
											<div id="rentOffer<s:property value="rentid"/>"
												class="rentOffer bg-primary" onclick="selectRentId(this.id)">
												<p>
													Rs.
												...
												<p>
													For
													<s:property value="periodvalue" />
													<s:property value="periodunit" />
												</p>
							...
							<s:else>
								...
								<div id="addToCartButton" class="btn_form" onclick="addToCart()"
									style="display: none">
									<a href="#">Add To Cart</a>
								</div>
							</s:else>
							...
							<h5><p class="money">
								Status : 
								<s:property
									value="context.ViewProductProjectorOB.productsDBBean.approvalStatus" />
							</p></h5>
							</s:elseif>
