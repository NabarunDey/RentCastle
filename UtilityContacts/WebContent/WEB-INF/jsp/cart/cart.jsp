			...
			<div class="shoping_bag1">
				<div class="shoping_left">
					...
					<div class="shoping1_of_2">
						...
						<span>qty <b>1</b></span>
						<ul class="s_icons">
							<li><a href="#"><img src="images/s_icon3.png" alt="">
									Remove</a></li>
						</ul>
					</div>
					<div class="clearfix"></div>
				...
				<div class="shoping_right">
					...
					<p>
						Rent Offer<span> Rs. <s:property value="rentAmount"/> For <s:property value="periodValue"/> <s:property value="periodUnit"/></span>
					</p>
				</div>
				<div class="clearfix"></div>
			</div>
