				...
				<s:iterator value="context.placeManagementProjectorOBs">
					<div class="col-md-3 col-sm-6 result">
						...
						<%-- <input type="hidden" id="place<s:property value="placesDBBean.placeid"/>"  value="<s:property value="getProductJson()"/>" /> --%>
							<a href="<s:url  action='viewPlace'><s:param name="placeId" value="placesDBBean.placeid"></s:param></s:url>">
								<div class="view view-fifth">
									<img src="<s:property value="profileImagePath"/>" style="width: 230px; height: 200px" class="img-responsive" alt="" />
									<div class="mask">
